...
Launch the [`make.R`](https://github.com/afbat/disscompendium/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/afbat/disscompendium/blob/main/CONTRIBUTING.md).
